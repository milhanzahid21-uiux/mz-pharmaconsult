...
window.QUESTION_BANK = [
  ...
  // ===== ADDITIONAL PHARMACOLOGY — ANTICANCER & RELATED =====
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Moderate",
    scenario: "",
    question: "Which alkylating agent is classified as a nitrogen mustard and is commonly used in lymphoma treatment?",
    options: ["Cyclophosphamide", "Methotrexate", "Vincristine", "Tamoxifen"],
    correctIndex: 0,
    explanation: "Cyclophosphamide is a nitrogen mustard alkylating agent that cross-links DNA strands, preventing replication. It is widely used in lymphomas and other cancers. Methotrexate is an antimetabolite, vincristine a vinca alkaloid, and tamoxifen an anti-hormonal agent.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Easy",
    scenario: "",
    question: "Methotrexate exerts its anticancer effect primarily by inhibiting which enzyme?",
    options: ["Topoisomerase II", "Dihydrofolate reductase", "Thymidine kinase", "Aromatase"],
    correctIndex: 1,
    explanation: "Methotrexate is a folate antimetabolite that inhibits dihydrofolate reductase, blocking synthesis of purines and thymidylate needed for DNA replication. This makes it effective against rapidly dividing cancer cells.",
  },
  {
    subject: "Pharmacology",
    style: "scenario",
    difficulty: "Moderate",
    scenario: "A 45-year-old woman with breast cancer is started on a drug that blocks estrogen receptors in breast tissue. She has no prior history of thromboembolic disease.",
    question: "Which anti-hormonal agent is most likely being used?",
    options: ["Tamoxifen", "Cyclophosphamide", "Methotrexate", "Bleomycin"],
    correctIndex: 0,
    explanation: "Tamoxifen is a selective estrogen receptor modulator (SERM) used in estrogen receptor-positive breast cancer. It blocks estrogen receptors in breast tissue but has partial agonist effects elsewhere, increasing risk of thromboembolism and endometrial cancer.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Hard",
    scenario: "",
    question: "Procarbazine is used in Hodgkin's lymphoma as part of the MOPP regimen. Its mechanism of action is best described as:",
    options: [
      "Inhibition of dihydrofolate reductase",
      "Alkylation of DNA after metabolic activation",
      "Inhibition of microtubule polymerization",
      "Blockade of estrogen receptors",
    ],
    correctIndex: 1,
    explanation: "Procarbazine is a prodrug that undergoes metabolic activation to produce reactive species that alkylate DNA, inhibiting DNA, RNA and protein synthesis. It also inhibits MAO, causing important drug and food interactions.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Moderate",
    scenario: "",
    question: "Which vinca alkaloid derived from Catharanthus roseus is preferred in childhood acute lymphoblastic leukemia?",
    options: ["Vinblastine", "Vincristine", "Vinorelbine", "Colchicine"],
    correctIndex: 1,
    explanation: "Vincristine is the preferred vinca alkaloid in childhood ALL. It inhibits microtubule polymerization, arresting mitosis at metaphase. Its major toxicity is peripheral neuropathy rather than myelosuppression, making it useful in combination regimens.",
  },
  {
    subject: "Pharmacology",
    style: "scenario",
    difficulty: "Moderate",
    scenario: "A patient on cancer chemotherapy develops severe oral mucositis and megaloblastic changes. The treating oncologist suspects folate pathway inhibition.",
    question: "Which antimetabolite is most likely responsible?",
    options: ["Cyclophosphamide", "Tamoxifen", "Methotrexate", "Chlorambucil"],
    correctIndex: 2,
    explanation: "Methotrexate inhibits dihydrofolate reductase, depleting reduced folates needed for DNA synthesis. This causes mucositis and megaloblastic changes. Leucovorin (folinic acid) rescue is used to reduce toxicity in high-dose regimens.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Easy",
    scenario: "",
    question: "Chloroquine exerts its antimalarial effect primarily by:",
    options: [
      "Inhibiting dihydrofolate reductase",
      "Accumulating in parasite food vacuoles and inhibiting heme polymerization",
      "Alkylating parasite DNA",
      "Blocking protein synthesis at the 50S ribosome",
    ],
    correctIndex: 1,
    explanation: "Chloroquine accumulates in the acidic food vacuole of Plasmodium, where it inhibits heme polymerization into hemozoin, causing toxic heme accumulation that kills the parasite. Resistance is due to mutations in the chloroquine resistance transporter (CRT).",
  },
  {
    subject: "Pharmacology",
    style: "scenario",
    difficulty: "Moderate",
    scenario: "A traveller returning from sub-Saharan Africa presents with fever, rigors and sweating every 48 hours. Blood film confirms Plasmodium falciparum infection. Chloroquine resistance is suspected in the region.",
    question: "Which combination is the current first-line treatment for uncomplicated falciparum malaria?",
    options: [
      "Chloroquine alone",
      "Artemisinin-based combination therapy (ACT)",
      "Primaquine alone",
      "Pyrimethamine-sulfadoxine alone",
    ],
    correctIndex: 1,
    explanation: "Artemisinin-based combination therapies (ACTs) are the WHO-recommended first-line treatment for uncomplicated P. falciparum malaria due to widespread chloroquine resistance. Primaquine is used for radical cure of P. vivax/ovale hypnozoites.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Moderate",
    scenario: "",
    question: "Primaquine is essential in the treatment of Plasmodium vivax malaria because it:",
    options: [
      "Kills blood-stage schizonts rapidly",
      "Eliminates dormant liver-stage hypnozoites preventing relapse",
      "Inhibits heme polymerization",
      "Blocks folate synthesis in the parasite",
    ],
    correctIndex: 1,
    explanation: "Primaquine is the only drug that eliminates hypnozoites (dormant liver stages) of P. vivax and P. ovale, preventing relapses. It must be used with caution in G6PD-deficient patients due to risk of hemolytic anemia.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Moderate",
    scenario: "",
    question: "Which antiprotozoal drug is first-line treatment for Giardia lamblia infection?",
    options: ["Chloroquine", "Metronidazole", "Amphotericin B", "Quinine"],
    correctIndex: 1,
    explanation: "Metronidazole is the drug of choice for giardiasis. It is a nitroimidazole that is reduced intracellularly to toxic metabolites that damage DNA of anaerobic and protozoal organisms. It is also used for amoebiasis and trichomoniasis.",
  },
  {
    subject: "Pharmacology",
    style: "scenario",
    difficulty: "Hard",
    scenario: "A patient with AIDS develops Pneumocystis jirovecii pneumonia (PCP). He is allergic to sulfonamides.",
    question: "Which alternative drug is most appropriate for PCP treatment in this patient?",
    options: ["Metronidazole", "Pentamidine", "Chloroquine", "Fluconazole"],
    correctIndex: 1,
    explanation: "Pentamidine is an alternative to co-trimoxazole (the first-line) for PCP in sulfonamide-allergic patients. It interferes with DNA, RNA and protein synthesis in Pneumocystis. Co-trimoxazole remains preferred when tolerated due to better efficacy and safety profile.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Easy",
    scenario: "",
    question: "Amphotericin B treats systemic fungal infections by binding to which component of the fungal cell membrane?",
    options: ["Chitin", "Ergosterol", "Peptidoglycan", "Beta-glucan"],
    correctIndex: 1,
    explanation: "Amphotericin B binds to ergosterol in the fungal cell membrane, forming pores that increase permeability and cause leakage of cellular contents. It has significant nephrotoxicity; liposomal formulations reduce this toxicity.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Moderate",
    scenario: "",
    question: "Fluconazole's antifungal mechanism involves inhibition of which enzyme in the ergosterol synthesis pathway?",
    options: ["Chitin synthase", "14-alpha demethylase (CYP51)", "Beta-glucan synthase", "Squalene epoxidase"],
    correctIndex: 1,
    explanation: "Fluconazole inhibits fungal CYP51 (14-alpha demethylase), blocking conversion of lanosterol to ergosterol. This depletes ergosterol and disrupts the fungal cell membrane. It is used for candidiasis and cryptococcal meningitis.",
  },
  {
    subject: "Pharmacology",
    style: "scenario",
    difficulty: "Moderate",
    scenario: "A diabetic patient develops oral candidiasis (thrush). She is on multiple medications and her physician wants a topical antifungal with minimal systemic absorption.",
    question: "Which antifungal is most appropriate for topical treatment of oral candidiasis?",
    options: ["Amphotericin B IV", "Nystatin oral suspension", "Fluconazole IV", "Griseofulvin"],
    correctIndex: 1,
    explanation: "Nystatin is a polyene antifungal used topically for oral and cutaneous candidiasis. It is poorly absorbed from the GI tract, making it safe for topical use with minimal systemic effects. Fluconazole is preferred for systemic or refractory infections.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Moderate",
    scenario: "",
    question: "Which antiviral drug is used prophylactically and therapeutically against influenza A and B by inhibiting neuraminidase?",
    options: ["Acyclovir", "Oseltamivir", "Zidovudine", "Ribavirin"],
    correctIndex: 1,
    explanation: "Oseltamivir (Tamiflu) inhibits neuraminidase, preventing release of new viral particles from infected cells and reducing spread. It is effective against influenza A and B when started within 48 hours of symptom onset.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Easy",
    scenario: "",
    question: "Acyclovir treats herpes simplex virus infection by which mechanism?",
    options: [
      "Inhibiting viral neuraminidase",
      "Acting as a false nucleoside that terminates viral DNA chain elongation",
      "Blocking viral cell entry",
      "Inhibiting reverse transcriptase",
    ],
    correctIndex: 1,
    explanation: "Acyclovir is phosphorylated by viral thymidine kinase to its active form, which then inhibits viral DNA polymerase and terminates DNA chain elongation. It is selective for HSV-infected cells because viral thymidine kinase is required for activation.",
  },
  {
    subject: "Pharmacology",
    style: "scenario",
    difficulty: "Hard",
    scenario: "A patient presents with altered consciousness, fever and focal neurological signs. CSF PCR confirms herpes simplex encephalitis.",
    question: "Which antiviral is the treatment of choice and by which route?",
    options: [
      "Oral acyclovir",
    ...
    correctIndex: 1,
    explanation: "Herpes simplex encephalitis requires high-dose intravenous acyclovir to achieve adequate CNS concentrations. Oral acyclovir does not achieve sufficient levels for encephalitis. Early treatment is critical to reduce mortality and neurological sequelae.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Moderate",
    scenario: "",
    question: "Organophosphate poisoning causes toxicity by which mechanism?",
    options: [
      "Blocking nicotinic receptors directly",
      "Irreversibly inhibiting acetylcholinesterase, causing ACh accumulation",
      "Stimulating muscarinic receptors directly",
      "Inhibiting catecholamine synthesis",
    ],
    correctIndex: 1,
    explanation: "Organophosphates irreversibly inhibit acetylcholinesterase, causing accumulation of acetylcholine at synapses. This produces both muscarinic effects (SLUDGE: salivation, lacrimation, urination, defecation, GI upset, emesis) and nicotinic effects (muscle weakness, paralysis).",
  },
  {
    subject: "Pharmacology",
    style: "scenario",
    difficulty: "Moderate",
    scenario: "A farmer presents with excessive salivation, lacrimation, miosis, bradycardia, bronchospasm and muscle fasciculations after working with pesticides.",
    question: "Which is the correct immediate treatment?",
    options: [
      "Adrenaline and flumazenil",
      "Atropine and pralidoxime",
      "Naloxone and sodium bicarbonate",
      "Vitamin K and fresh frozen plasma",
    ],
    correctIndex: 1,
    explanation: "Atropine blocks muscarinic effects of accumulated acetylcholine in organophosphate poisoning. Pralidoxime reactivates acetylcholinesterase if given early before irreversible 'aging' occurs. Together they address both muscarinic and nicotinic toxicity.",
  },
  {
    subject: "Pharmacology",
    style: "simple",
    difficulty: "Hard",
    scenario: "",
    question: "Which antidote is specifically used in cyanide poisoning by providing an alternative electron acceptor for cytochrome oxidase?",
    options: [
      "N-acetylcysteine",
      "Hydroxocobalamin",
      "Flumazenil",
    ...
    correctIndex: 1,
    explanation: "Hydroxocobalamin binds cyanide to form cyanocobalamin (vitamin B12), which is renally excreted. Cyanide inhibits cytochrome c oxidase, blocking cellular respiration. N-acetylcysteine is for paracetamol, flumazenil for benzodiazepines, and desferrioxamine for iron poisoning.",
  },
